...
if(correctList.length >= 1){
    ...
    // correct answer:
    let idSelected = randomChoice(correctList.length+1);
    ...
    // Op 2:
    let idSelected2 = randomChoice(optionsToSelect.length+1);
    ...
    // Op 3:
    let idSelected3 = randomChoice(optionsToSelect.length+1);
    ...
    // Op 4:
    let idSelected4 = randomChoice(optionsToSelect.length+1);
