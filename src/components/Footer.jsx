...
const Footer = (languaje)=>{
    ...
    return(
        <footer className="footer">
            ...
            <section className="footer-data">
                <a target="_blank" rel="noreferrer" style={{"overflow": "clip"}} href="mailto:manufuentemoreno@gmail.com"><FaEnvelope/><p className="footer-text">  manufuentemoreno@gmail.com</p></a>
